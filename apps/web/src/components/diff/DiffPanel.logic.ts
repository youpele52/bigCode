...
import { parseDiffRouteSearch, stripDiffSearchParams } from "../../utils/diff";
...
/** All state and derived data for the turn strip scroll controls. */
export function useTurnStripScroll() {
...
/** All checkpoint diff state resolved from route params + thread store. */
export function useDiffPanelData() {
