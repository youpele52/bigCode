...
import { NonNegativeInt, PositiveInt, ThreadId, TrimmedNonEmptyString } from "../core/baseSchemas";
import {
  GIT_STACKED_ACTIONS,
...
const GitStatusPrState = Schema.Literals(GIT_PR_STATES);
const GitPullRequestReference = TrimmedNonEmptyStringSchema;
const GitPullRequestState = Schema.Literals(GIT_PR_STATES);
const GitPreparePullRequestThreadMode = Schema.Literals(GIT_PREPARE_PR_THREAD_MODES);
